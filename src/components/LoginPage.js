...
import { getUsername, userLogin } from '../slices/authenticationSlice';
...
const LoginPage = () => {
  ...
  return (
    <Box>
      ...
      <Box sx={{right: 0, height: "100%", width: "40%", position: "fixed", paddingTop: "24px", background: "white", boxShadow: "10"}}>
        <Box sx={{margin: "60px"}}>
          <Typography 
            style={{
          ...
          display= "block">
          Crosscrop</Typography>
          <Typography 
            align="center"
            variant="loginPanelSubheader"
            display="block"
          >Start Your Breeding Journey.</Typography>
